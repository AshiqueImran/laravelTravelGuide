...
<html>
    <head>
        <title>Intelligent Travel Guide</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container-fluid mainDiv">
            <div class="row marginContent">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 content text-center center-block">
                    <h1 class="text-capitalize">Intelligent Travel Guide</h1>
                    <p>Your travel guide, at your service</p>
                    <div class="row marginButton">
                        <div class="col-md-2 col-sm-2"></div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a class="btn btnLogin" href="/login">LOG IN</a>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a class="btn btnRegistration" href="/reg">REGISTRATION</a>
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                    </div>
                    <a class="btn btnAdmin" href="/admin">ADMIN LOG IN</a>
                    <div class="col-md-3 col-sm-3"></div>
                </div>
            </div>
            <div class="goku"></div>
