        ...
        <div class="container-fluid addNewInfoDiv">
            <div class="container contentAddInfo">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 backgroundInfo">
                    <h1 class="text-capitalize adminLogInHeader text-center">edit info</h1>
                    <form method="post">
                    
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="text-capitalize">place name</label><br>
                        <input type="text" name="plcaeName" class="form-control" maxlength="90" value="{{$res[0]->plcaeName}}" required style="height: 40px; border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">
                    </div>

                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="text-capitalize">details</label><br>
                        <textarea class="form-control" name="details" rows="4" maxlength="220" required style="border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">{{$res[0]->details}}</textarea>
                    </div>

                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="text-capitalize">hotel</label><br>
                       <input type="text" name="hotel" class="form-control" maxlength="200" value="{{$res[0]->hotel}}" required style="height: 40px; border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">
                    </div>
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="text-capitalize">Map</label><br>
                       <input type="text" name="map" class="form-control" value="{{$res[0]->map}}" required style="height: 40px; border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">
                    </div>
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="text-capitalize">capacity</label><br>
                        <input type="number" name="capacity" class="form-control" value="{{$res[0]->capacity}}" style="height: 40px; border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">
                    </div>
                    <div class="category">
                        <label for="category">category(Previous: {{$res[0]->category}})</label>
