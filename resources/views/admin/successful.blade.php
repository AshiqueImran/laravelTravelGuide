...
<html>
    ...
    <body>
        ...
        <div class="container-fluid successDiv">
            <div class="row marginContentSuccess text-center center-block">
                <div class="col-md-2 col-sm-2 col-xs-1"></div>
                <div class="col-md-8 col-sm-8 col-xs-10 backgroundSuccessContent">
                    <h1 class="headerSuccess text-uppercase">you've added successfully..!!<br>
                        <span style="font-size: 35px;">we are glad to have you on board</span></h1>
                    <a class="btn text-uppercase btnRidirect" href="/admin/home">Admin Home</a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-1"></div>
            </div>
        </div>
