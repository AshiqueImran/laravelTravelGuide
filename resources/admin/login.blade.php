        ...
        <div class="container-fluid adminLogin">
            <div class="container contentAdminLogin">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 background">
                    <h1 class="text-capitalize adminLogInHeader text-center">admin panel</h1>
                    <form method="post">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="password" name="adminPass" class="form-control" style="height: 40px; border-radius: 0px; background-color: transparent; border: 1px solid white; color:white;">
                    </div>
                    <input class="btn btnAdminLogIn text-capitalize" type="submit" value="Admin log in">
