...
<html>
    ...
    <body>
        ...
        <div class="container-fluid addNewAdminDiv">
            <div class="container contentAdminLogin">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 background">
                    <h1 class="text-capitalize adminLogInHeader text-center">add new admin</h1>
                    ...
                    <input type="submit" id="submit" class="btn btnAdminLogIn text-capitalize" value="Add admin">
                    <!-- <a class="btn btnAdminLogIn text-capitalize" href="#">Add</a> -->
                </form>
                </div>
                <div class="col-md-3 col-sm-3"></div>
            </div>
